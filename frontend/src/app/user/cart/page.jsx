...
const Cart = () => {
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto">
      ...
      {cartitems.map((item) => (
        <div key={item.productid} className="flex justify-between items-center border p-4 rounded mb-3">
          <div>
          ...
          <div className="flex items-center gap-2">
            ...
            />
            <button onClick={() => removeFromCart(item.productId)} className="text-red-500 font-medium">
              Remove
            </button>
          </div>
        </div>
